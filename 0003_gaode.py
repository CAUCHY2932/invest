...
def parse_addr_json(addr):
    ...
    if addr_json["status"] == "1":
        ...
        return 1, adcode, citycode, province, city, distinct, lat_lng
        # return {
        #     "parse_status": "1",
        #     "adcode": adcode,
        #     "citycode": citycode,
        ...
        #     "lat_lng": lat_lng,
        # }
    return 0, adcode, citycode, province, city, distinct, lat_lng
    # return {
    #     "parse_status": "0",
    #     "adcode": "",
    #     "citycode": "",
...
def process(chunk):
    ...
    with open('D:/0621001.csv', 'a') as f:
        # f.write()
        ...
        for _, item in chunk.iterrows():
            ...
            parsed_addr = parse_addr_json(addr)
